      ...
      >
        <div className="font-gilroy w-[50%] ml-10 flex flex-col border border-red-700 ">
         ...
         <div  className='border border-red-700 '>
          ...
          <p className="font-gilroy font-light text-lg md:text-xl mb-10  w-full  md:w-auto">I’m a Data Science and Artificial Intelligence student at the National Polytechnic School of Algiers, deeply passionate about Machine Learning, Data Analysis, and Web dev. I’m eager to explore this vast domain, continually learn, and improve every day.  If you’re interested in collaborating, feel free to reach out I’m always open to new opportunities and connections!</p>
          </div>
